...
export function MobileMap({
  ...
  const hasNativeCenteredRef = useRef(false);
  ...
  useEffect(() => {
    if (!mapReady || hasFittedRef.current || route?.coordinates.length) return;
  ...
  }, [mapReady, currentLocation, chargers, route?.coordinates.length]);
